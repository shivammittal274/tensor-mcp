...
This directory is a fork of the Klavis MCP google_drive server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/google_drive
...
Spawned as a subprocess via `klavisPython("vendored/google_drive")` (entry: `server.py`).
