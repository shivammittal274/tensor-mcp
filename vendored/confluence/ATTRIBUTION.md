...
This directory is a fork of the Klavis MCP confluence server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/confluence
...
Spawned as a subprocess via `klavisPython("vendored/confluence")` (entry: `server.py`).
