...
This directory is a fork of the Klavis MCP google_calendar server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/google_calendar
...
Spawned as a subprocess via `klavisPython("vendored/google_calendar")` (entry: `server.py`).
