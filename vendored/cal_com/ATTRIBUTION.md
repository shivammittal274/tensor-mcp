...
This directory is a fork of the Klavis MCP cal_com server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/cal_com
...
Spawned as a subprocess via `klavisPython("vendored/cal_com")` (entry: `server.py`).
