...
This directory is a fork of the Klavis MCP openrouter server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/openrouter
...
Spawned as a subprocess via `klavisPython("vendored/openrouter")` (entry: `server.py`).
