...
This directory is a fork of the Klavis MCP google_sheets server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/google_sheets
...
Spawned as a subprocess via `klavisPython("vendored/google_sheets")` (entry: `server.py`).
