...
This directory is a fork of the Klavis MCP figma server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/figma
...
Spawned as a subprocess via `klavisPython("vendored/figma")` (entry: `server.py`).
