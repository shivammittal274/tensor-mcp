...
This directory is a fork of the Klavis MCP clickup server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/clickup
...
Spawned as a subprocess via `klavisPython("vendored/clickup")` (entry: `server.py`).
