...
This directory is a fork of the Klavis MCP dropbox server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/dropbox
...
Spawned as a subprocess via `klavisTypescript("vendored/dropbox")` (entry: `src/index.ts`).
