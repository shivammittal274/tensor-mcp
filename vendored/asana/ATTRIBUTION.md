...
This directory is a fork of the Klavis MCP asana server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/asana
...
Spawned as a subprocess via `klavisPython("vendored/asana")` (entry: `server.py`).
