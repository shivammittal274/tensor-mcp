...
This directory is a fork of the Klavis MCP google_docs server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/google_docs
...
Spawned as a subprocess via `klavisPython("vendored/google_docs")` (entry: `server.py`).
