...
This directory is a fork of the Klavis MCP trello server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/trello
...
Spawned as a subprocess via `klavisPython("vendored/trello")` (entry: `server.py`).
