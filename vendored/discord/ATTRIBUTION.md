...
This directory is a fork of the Klavis MCP discord server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/discord
...
Spawned as a subprocess via `klavisPython("vendored/discord")` (entry: `server.py`).
