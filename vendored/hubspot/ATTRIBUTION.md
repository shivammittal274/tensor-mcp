...
This directory is a fork of the Klavis MCP hubspot server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/hubspot
...
Spawned as a subprocess via `klavisPython("vendored/hubspot")` (entry: `server.py`).
