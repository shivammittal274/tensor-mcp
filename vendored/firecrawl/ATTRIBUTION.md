...
This directory is a fork of the Klavis MCP firecrawl server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/firecrawl
...
Spawned as a subprocess via `klavisTypescript("vendored/firecrawl")` (entry: `index.ts`).
