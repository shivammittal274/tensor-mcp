...
This directory is a fork of the Klavis MCP perplexity_ai server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/perplexity_ai
...
Spawned as a subprocess via `klavisPython("vendored/perplexity_ai")` (entry: `server.py`).
