...
This directory is a fork of the Klavis MCP tavily server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/tavily
...
Spawned as a subprocess via `klavisPython("vendored/tavily")` (entry: `server.py`).
