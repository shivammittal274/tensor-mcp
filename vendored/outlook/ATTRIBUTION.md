...
This directory is a fork of the Klavis MCP outlook server.

- **Upstream source**: https://github.com/Klavis-AI/klavis/tree/main/mcp_servers/outlook
...
Spawned as a subprocess via `klavisPython("vendored/outlook")` (entry: `server.py`).
